					...
					<div class="search">
						<h3>Notícias</h3>
			                                ...
			                                <input type="text" name="email" value="Seu Email" onfocus="javascript:(this.value == 'Seu Email' ? this.value = '' : null);" onblur="javascript:(this.value == '' ? this.value = 'Seu Email' : null);" />
                                                        <input hidden="" type="text" name="nome_email" value="noticias">
                                                        <input hidden="" type="text" name="fone_email" value="noticias">
                                                        <input hidden="" type="text" name="msg_email" value="noticias">
